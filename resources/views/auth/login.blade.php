		...
		<div class="container-login100">
            ...
            <span class="login100-form-title p-b-43">
                    ...
                    <div class="container-login100-form-btn">
                        ...
                        <a class="login100-form-btn" href="{{url('register')}}">Sign Up</a>
					</div>
					...
					<div class="login100-form-social flex-c-m">
						<a href="https://www.facebook.com/username/dashdboard" class="login100-form-social-item flex-c-m bg1 m-r-5">
